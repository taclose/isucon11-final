...
(
    ...
    KEY `index_courses_teacher_id` (`teacher_id`)
);
...
(
    ...
    KEY `index_registrations_course_id` (`course_id`),
    KEY `index_registrationss_user_id` (`user_id`)
);
...
(
    ...
    KEY `index_classes_course_id` (`course_id`)
);
...
(
    ...
    KEY `index_submissions_user_id` (`user_id`),
    KEY `index_submissions_class_id` (`class_id`)
);
...
(
    ...
    KEY `index_announcements_course_id` (`course_id`)
);
...
(
    ...
    KEY `index_unread_announcements_announcement_id` (`announcement_id`),
    KEY `index_unread_announcements_user_id` (`user_id`)
);
